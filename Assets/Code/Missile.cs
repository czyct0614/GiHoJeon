...
public class Missile : MonoBehaviour
{
   ...
   {   
    // 충돌한 오브젝트가 몬스터인 경우
    if (other.gameObject.name!="Player" && other.CompareTag("Monster") && !other.CompareTag("FlyingPlatform"))
        {
            // 몬스터에게 대미지를 줌
    ...
    else if(other.gameObject.name!="Player" && !other.CompareTag("Item") && !other.CompareTag("Portal") && !other.CompareTag("FlyingPlatform") && !other.CompareTag("Range") && !other.CompareTag("Skill") && !other.CompareTag("Else")){
                Destroy(gameObject);
            }
   }
}
